const TIMELINE_ITEMS = [
  {
    ...
    description: 'Microscopic dormant spores — the complete genetic blueprints for the entire habitat — are released onto the prepared Martian surface. Total payload mass: grams, not tonnes.',
...
export function DeploymentSection() {
  return (
    <section id="deployment" className="py-[120px]" style={{
      background: 'linear-gradient(180deg, #020610 0%, #030810 50%, #020610 100%)',
    }}>
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="relative mt-20">
          ...
          <div className="absolute left-6 md:left-1/2 md:-translate-x-px top-0 bottom-0 w-0.5"
            style={{ background: 'linear-gradient(180deg, rgba(34,211,238,0.0), rgba(34,211,238,0.3) 20%, rgba(52,211,153,0.3) 80%, rgba(52,211,153,0.0))' }}
          />
                ...
                <div className={`ml-16 md:ml-0 md:w-[45%] ${i % 2 === 1 ? 'md:text-right' : ''}`}>
                  ...
                  >
                    ...
                    <div className="mt-4 p-3 rounded-lg" style={{ background: `${item.color}07`, borderLeft: `2px solid ${item.color}35` }}>
                      ...
                      <p className="font-body text-xs text-bd-text/52 leading-relaxed">{item.why}</p>
                    </div>
                  </div>
                </div>
